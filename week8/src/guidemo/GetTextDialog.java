...
public class GetTextDialog extends JDialog {
    ...
    /**
     * Display the dialog box, wait for the user to dismiss it, and return the user's
     * input, or null if the user cancels the dialog.
     * 
     * @param parent      A component whose frame is the parent of the dialog box.
     * @param initialText the initial contents of the input box; if null, the box is
     *                    initially empty.
