...
/**
 * This class provides a slightly simplified interface to one of Java's standard JFileChooser dialogs.
 * An object of type SimpleFileChooser has methods that allow the user to select files for input or output.
 * If the object is used several times, the same JFileChooser is used each time.
 * By default, the dialog box is set to the user's home directory the first time it is used,
 * and after that, it remembers the current directory between one use and the next.
 * However, methods are provided for setting the current directory.
 */
public class SimpleFileChooser {
     ...
     * The next time the dialog appears, it will show the contents of that directory.
     */
    ...
    /**
     * Set the default directory for the dialog box.
     * The next time the dialog appears, it will show the contents of that directory.
     ...
     * Set the default directory for the dialog box.
     * The next time the dialog appears, it will show the contents of that directory.
     * @param directory The name of the new default directory.
     *                  If the name is null, then the user's home directory will be used.
     */
     ...
     * @param parent The component whose frame is the parent of the dialog box.
     * @return The selected file, or null if the user did not select a file.
     * @see #getInputFile(Component, String)
     */
     ...
     *               the parent component becomes the parent window of the dialog box.
     *               This means that the window is "blocked" until the dialog is dismissed.
     *               Also, the dialog box's position on the screen should be based on the position of the window.
     *               Generally, you should pass your application's main window or panel as the value of this parameter.
     * @param dialogTitle A title to be displayed in the title bar of the dialog box.
     *                    If the value of this parameter is null, then the dialog title will be "Select Input File".
     * @return The selected file, or null if the user did not select a file.
     */
    ...
    /**
     * Show a dialog box where the user can select a file for writing.
     * This method simply calls `getOutputFile(parent, null, null)`.
     * @param parent The component whose frame is the parent of the dialog box.
     * @return The selected file, or null if no file was selected.
     * @see #getOutputFile(Component, String, String)
     */
     ...
     * @param parent The component whose frame is the parent of the dialog box.
     * @param dialogTitle A title to be displayed in the title bar of the dialog box.
     *                    If the value of this parameter is null, then the dialog title will be "Select Output File".
     * @return The selected file, or null if no file was selected.
     * @see #getOutputFile(Component, String, String)
     */
     ...
     * Note that it is not guaranteed that the selected file is actually
     ...
     * @param dialogTitle A title to be displayed in the title bar of the dialog box.
     *                    If the value of this parameter is null, then the dialog title will be "Select Output File".
     * @param defaultFile When the dialog appears, this name will be filled in as the name of the selected file.
     *                    If the value of this parameter is null, then the file name box will be empty.
     * @return The selected file, or null if the user did not select a file.
     */
