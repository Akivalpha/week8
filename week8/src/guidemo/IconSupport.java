...
public class IconSupport {
    ...
    public IconSupport(DrawPanel owner) {
        panel = owner;
        // Array of icon names for the buttons
        String[] iconNames = {"bell", "camera", "flower", "star", "check", "crossout", "tux", "bomb", "keyboard", "lightbulb", "tv"};
    ...
    private class NoIconAction extends AbstractAction {
        NoIconAction() {
            ...
            putValue(Action.SHORT_DESCRIPTION, "Use Mouse to Erase Icons");
        }

        public void actionPerformed(ActionEvent evt) {
            BufferedImage currentImage = panel.getCurrentDrawImage();
