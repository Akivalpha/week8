...
public class GuiDemo extends JFrame {
    ...
    public GuiDemo() {
        ...
        drawPanel.setBackgroundImage(Util.getImageResource("earthrise.jpeg"));
        ...
        setLocation((screenSize.width - getWidth()) / 2, 40);
    ...
    // Create the "File" menu from actions
    ...
    private AbstractAction newPictureAction = new AbstractAction("New",
            Util.iconFromResource("fileopen.png")) {
        public void actionPerformed(ActionEvent evt) {
            drawPanel.clear();
    ...
    private AbstractAction quitAction = new AbstractAction("Quit",
            Util.iconFromResource("exit.png")) {
        public void actionPerformed(ActionEvent evt) {
            System.exit(0);
        }
    };
    ...
    private AbstractAction saveImageAction = new AbstractAction("Save Image...",
            Util.iconFromResource("filesave.png")) {
        public void actionPerformed(ActionEvent evt) {
                ...
                try {
                    ...
                    if (fileName.endsWith(".png"))
                        ...
                        JOptionPane.showMessageDialog(drawPanel,
                                "The output file name must end with .png or .jpeg.");
                        return;
                    }
    ...
    private class ChooseBackgroundAction extends AbstractAction {
        ...
        ChooseBackgroundAction(String text) {
            ...
            if (!text.equals("Custom...") && !text.equals("Color...")) {
                putValue(Action.SMALL_ICON, Util.iconFromResource( text.toLowerCase() + "_thumbnail.jpeg"));
            }
