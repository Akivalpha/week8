...
/**
 * This class provides some static utility functions for working with resources (to
 * avoid having to look up all the messy details). Resources are stored somewhere
 * on the class path, usually in their own package. They are located by paths to
 * files, such as "resources/images/mandelbrot.jpeg".
 */
public class Util {
    ...
    /**
     * Load a buffered image from a resource. In this case, the method does not return
     * until the image data has been read and stored in memory.
     * 
     * @param pathToResource the path to the resource.
